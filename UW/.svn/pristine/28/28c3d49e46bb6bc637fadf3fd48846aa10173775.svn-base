...
plt.text( 0.2, -1.03, '$\\left| gg \\right>$' )
plt.plot( [-0.1, 0.1], [1, 1], 'k', linewidth=2.0 )
plt.text( 0.2, 0.97, '$\\left| ee \\right>$' )

for y, n in zip( (-0.2, 0, 0.2), ("n-1", "n", "n+1") ):
    plt.plot( [-0.8, -0.6], [y, y], 'k', linewidth=2.0 )
    plt.text( -1.35, y-0.03, '$\\left| e g \\right> \\left| {} \\right>$'.format(n) )
    plt.plot( [0.6, 0.8], [y, y], 'k', linewidth=2.0 )
    plt.text( .85, y-0.03, '$\\left| g e \\right> \\left| {} \\right>$'.format(n) )
...
ax.annotate( '', xytext=(0.72, 0.02), xy=(0.72, -0.22), 
	arrowprops=dict(arrowstyle="<|-|>", linewidth=2.0) )
ax.annotate( '$\\nu$', xy=( 0.76, -0.13 ) )
