...
ax.add_artist( Arrow3D( [0, 0], [0, 0], [0, 1], mutation_scale=20, lw=3, arrowstyle="-|>", color='g' ) )
#ax.add_artist( Arrow3D( [0, 0], [0, 0], [0, 1], mutation_scale=20, lw=3, arrowstyle="-|>", color='k' ) )
ax.add_artist( Arrow3D( [0, 0], [0, 0], [0, -1], mutation_scale=20, lw=3, arrowstyle="-|>", color='g' ) )
#ax.add_artist( Arrow3D( [0, 1/np.sqrt(2.5)], [0, 0], [0, -1/np.sqrt(2.5)], mutation_scale=20, lw=3, arrowstyle="-|>", color='b' ) )
ax.add_artist( Arrow3D( [0, 1/np.sqrt(1.25)], [0, 0], [0, 1/np.sqrt(1.25)], mutation_scale=20, lw=3, arrowstyle="-|>", color='r' ) )
...
#ax.text( 0, 0, 1.1, "$\\hat{z}$", size=20 )
ax.text( 1.15, -0.1, 0, "$\\hat{x}$", size=20 )
ax.text( 0.1, -1.35, 0, "$\\hat{y}$", size=20 )
ax.text( 0, 0, -1.3, "$\\left| 0 \\right>$", size=20 )
#ax.text( 0, 0, -1.3, "$R$", size=20 )
ax.text( 0.9, 0, 0.9, "$R$", size=20 )
#ax.text( 0.7, 0, -0.8, "$W$", size=20 )
plt.show()
