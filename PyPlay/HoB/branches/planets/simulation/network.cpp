...
void wrap_network() {
	...
	enum_<NetworkView::Serialization>( "Serialization" )
		.value( "ReliableDelta", NetworkView::ReliableDelta )
		.value( "UnreliableFullState", NetworkView::UnreliableFullState )
		;

	enum_<NetworkView::ComponentSource>( "ComponentSource" )
		.value( "AllComponents", NetworkView::AllComponents )
		.value( "FirstComponent", NetworkView::FirstComponent )
		;

	enum_<NetworkView::Routing>( "Routing" )
		.value( "All", NetworkView::All )
		.value( "PotentiallyVisible", NetworkView::PotentiallyVisible )
		.value( "Others", NetworkView::Others )
		.value( "Single", NetworkView::Single )
		;

	class_<NetworkView, NetworkView::pointer_type, boost::noncopyable >
			( "NetworkView", no_init )
		.def_readwrite( "entity_id", &NetworkView::entity_id )
		.def_readwrite( "network_id", &NetworkView::network_id )
		.def_readwrite( "serialization", &NetworkView::serialization )
		.def_readwrite( "source", &NetworkView::serialization )
		.def_readwrite( "routing", &NetworkView::routing )
		.def_readwrite( "component", &NetworkView::component )
		;
	...
	class_< Server, boost::noncopyable  >( "Server", 
		init<double, Server::connect_cb_type, Server::new_entity_cb_type>() )
